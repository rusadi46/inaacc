...
<html lang="en" >
    ...
    <head>
        ...
        <!--end::Web font -->        
		<!--begin::Base Styles -->
			<link href="{{ asset('pages/css/vendors.bundle.css') }}" rel="stylesheet" type="text/css" />
			<link href="{{ asset('pages/css/style.bundle.css') }}" rel="stylesheet" type="text/css" />
        <!--end::Base Styles -->
		...
		<div class="m-login__contanier">			
			<div class="m-login__signin">
				...
				<form class="m-login__form m-form" method="POST" action="{{ route('login') }}">
					...
					<div class="form-group m-form__group">
						<input class="form-control m-input" type="password" placeholder="Password" name="password" required="required">
					...
					<div class="m-login__form-action">
						<button type="submit" href="" id="submit" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air">Sign In</button>
					</div>
				</form>
			</div>
...
<!-- end:: Page -->
    	<!--begin::Base Scripts -->        
	    	<script src="{{ asset('pages/js/vendors.bundle.js') }}" type="text/javascript"></script>
	    	<script src="{{ asset('pages/js/scripts.bundle.js') }}" type="text/javascript"></script>
